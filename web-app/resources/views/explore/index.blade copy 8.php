                    ...
                    if (distance <= 10000) {
                        ...
                        if (!uniqueLocations.has(station.location)) {
                            ...
                            nameDiv.innerHTML = `
                                                            ...
                                                            <span class="text-dark fw-semibold">  ${station.location} - ${station.county}  <br>( ${station.distance} mi away ) </span>     <br>  Frequency : ${station.frequency} MHz
                                                        `;
                            ...
                            if (stationCount > 5) {
                                ...
                                nearbyallstationsList.style.maxHeight =
                                    '600px'; // Adjust the maximum height as needed
                            }
                        }
                    }
                });
