    ...
    <main id="content" role="main" class="main">
        <div class="container px-lg-3 px-2 mb-3">
            <div class="row  mt-2">
                ...
                <div class="col-lg-2 col-md-3 col-sm-9 " style="display: none">
                    <div class="row  mb-2">
                    ...
                    if (distance <= 10000) {
                        ...
                        if (!uniqueLocations.has(station.location)) {
                            ...
                            nameDiv.innerHTML = `
                                                            ...
                                                            <span class="text-dark fw-semibold">  ${station.location} - ${station.county}  <br>( ${station.distance} mi away ) </span>     <br>  Frequency : ${station.frequency} 
                                                        `;
