...
<html lang="en" dir>
  ...
  <head>
    ...
    <!-- contact form css -->
    <link rel="stylesheet" href="{{asset('front_asset/node_modules/leaflet/dist/leaflet.css')}}" />
...
<style>
  ...
  <body>
      ...
      style="background-image: url('{{ asset('front_asset/img/svg/components/card-11.svg') }}');">
        <div class="d-lg-flex position-relative content-space-t-1" id="home">
          <div class="container d-lg-flex align-items-lg-center content-space-t-1 content-space-lg-0 min-vh-lg-100">
            ...
            <div class="w-100">
              <div class="row">
                ...
                <div class="d-grid d-md-flex gap-3 align-items-md-center">
                  <a class="btn btn-primary"  href="{{asset('https://docs.boondockecho.com/')}}" target="_blank">Get Started</a>

                  <!-- Fancybox -->
                  <a class="video-player video-player-btn" href="{{asset('https://docs.boondockecho.com/boondock-echo/user-interface/start-guide')}}" target="_blank" role="button" >
            ...
            <!-- SVG Shape -->
            <div
              class="col-lg-6 col-xl-6 d-none d-lg-block position-absolute top-3 end-0 pe-0"
    ...
    <div class="w-lg-75 text-center mx-lg-auto content-space-t-1" id="about">
      <!-- Heading -->
      <div class="mb-2 mt-3">
        <h6 class="display-6 text-navy-blue">About <span
            class="display-5 text-primary   mb-3">Boondock Echo</span></h6>
    ...
    <div class="container content-space-b-1 ">
      ...
      <div class="row justify-content-lg-between align-items-md-center content-space-t-1 content-space-t-lg-0 pb">
        ...
        <div class="col-md-6 col-lg-6  col-sm-12 order-md-1">
          <div class="bg-img-center h-100 rounded-2 text-center rounded-2 d-flex justify-content-center align-items-center"  style="background-image: url('{{ asset('front_asset/img/boondock-logo2-crop.png') }}'); min-height: 20rem; ">
            ...
            <div id="video-container">
              ...
              <div id="cancel-button" onclick="closeVideo()">
                <button type="button" class="btn btn-close btn btn-outline-primary  btn-icon " data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <iframe id="video-iframe" width="610" height="400" src="https://www.youtube.com/embed/5CJuMuLHsgM" frameborder="0" allowfullscreen></iframe>
            </div>
...
<style>
  #play-icon {
    ...
    background-image: url(./assets/img/boondock-logo2-crop.png); /* Adjust the color of the icon background as needed */
    color: #fff; /* Adjust the color of the icon itself as needed */
    cursor: pointer;
    text-align: center;
    line-height: 50px;
  }
...
<!-- new Features end -->
    ...
    <div class="container ">
      ...
      <div class="w-md-75 w-lg-50 text-center mx-md-auto mb-5 mb-md-9">
        ...
        <h6 class="display-6 text-navy-blue">Key<span
            class="display-5 text-primary   mb-3"> Features</span></h6>
        <!-- <h2>Key Features</h2> -->
      </div>
      <!-- End Heading -->
...
<!-- services end -->
    <!--services Card Grid -->
        ...
        <div class="container content-space-1 bg-gradient " id="services">
          ...
          <div class="text-center mx-md-auto mb-3 mb-md-3 sticky-heading">
            ...
            <h6 class="display-6 text-navy-blue">Our<span
                class="display-5 text-primary "> Services</span></h6>
    ...
    <!-- Team -->
    <div id="team"></div>
    <div class=" bg-dark rounded-2 mx-2 mx-xl-10 content-space-2 content-space-lg-2  " style="background-image: url('{{ asset('assets/svg/components/wave-pattern-light.svg') }}');"  >
  
      <!-- Heading -->
      <div class="w-md-75 w-lg-50 text-center mx-md-auto mb-2 mb-md-9 mb-sm-4" >
        <span class="text-cap text-muted">Our team</span>
        <h6 class="display-6 text-white">Our<span
            class="display-5 text-primary   mb-1"> Creative Minds</span></h6>
          ...
          <div class="col-sm-12 col-lg-4 mb-3 ">
            ...
            <div class="card card-transition h-100" data-bs-toggle="modal"
              ...
              <div class="card-body">
                ...
                <p class="card-text text-navy-blue">Mark Hughes, the brain behind Boondock Echo, has always been fascinated with communication technology and its end<a href="mySmallModalLabelkc"  data-bs-toggle="modal"
                  data-bs-target=".bd-example-modal-sm-mark" class="text-muted">  ...read more</a></p>
            ...
            <!-- End Card -->
            <!-- Modal -->
            <div class="modal modal-lg fade bd-example-modal-sm-mark content-space-4"
              tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabelkc"
              aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h5 class="modal-title lead h4 text-navy-blue" id="mySmallModalLabelkc">Mark Hughes -</h5>
                    <h5 class="modal-title lead h4 text-primary" id="mySmallModalLabelkc">The Visionary</h5>

                    <button type="button" class="btn-close"
                      data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <span class="divider-end mt-2"></span>
                  <div class="modal-body text-navy-blue">Mark Hughes, the brain behind Boondock Echo, has always been fascinated with communication technology and its endless possibilities. With a strong background in electronics engineering and a passion for the outdoors, Mark saw a gap in the two-way radio market. His vision for a device that could not just communicate but also record and playback radio messages led to the creation of Boondock Echo. Mark believes in pushing the boundaries of technology to better serve the needs of our society, and his dream of redefining two-way radio communication fuels our company.
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-12 col-lg-4 mb-3 ">
            ...
            <div class="card card-transition h-100" data-bs-toggle="modal"
              ...
              <div class="card-body">
                ...
                <p class="card-text text-navy-blue">Emelia Chandel, the maestro of our firmware team, is responsible for the brain every Boondock Echo. With a strong background <a href="mySmallModalLabelkc"  data-bs-toggle="modal"
            ...
            <!-- End Card -->
            <!-- Modal -->
            <div class="modal modal-lg fade bd-example-modal-sm-kc content-space-4"
              tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabelkc"
              aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h5 class="modal-title lead h4 text-navy-blue" id="mySmallModalLabelkc">Emelia Chandel  -</h5>
                    <h5 class="modal-title lead h4 text-primary" id="mySmallModalLabelkc">The Firmware Maestro</h5>

                    <button type="button" class="btn-close"
                      data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <span class="divider-end mt-2"></span>
                  <div class="modal-body text-navy-blue">Emelia Chandel, the maestro of our firmware team, is responsible for the brain inside every Boondock Echo. With a strong background in computer engineering and an innate ability to solve complex problems, Emelia ensures our device not only meets but exceeds the high standards of functionality and reliability we set. Her deep understanding of firmware intricacies and relentless dedication make her the pillar of our technical team, ensuring that our devices deliver superior performance in every situation.
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-12 col-lg-4 mb-3 ">
            ...
            <div class="card card-transition h-100" data-bs-toggle="modal"
              ...
              <div class="card-body">
                ...
                <p class="card-text text-navy-blue">Jesse Robinson, our hardware architect, breathes life into the Boondock Echo. An experienced and innovative electronics <a href="mySmallModalLabelkc"  data-bs-toggle="modal"
                  data-bs-target=".bd-example-modal-sm-jesse" class="text-muted">  ...read more</a></p>
            ...
            <!-- End Card -->
            <!-- Modal -->
            <div class="modal modal-lg fade bd-example-modal-sm-jesse content-space-4"
              tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabelkc"
              aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h5 class="modal-title lead h4 text-navy-blue" id="mySmallModalLabelkc">Jesse Robinson -</h5>
                    <h5 class="modal-title lead h4 text-primary" id="mySmallModalLabelkc">The Hardware Architect</h5>

                    <button type="button" class="btn-close"
                      data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <span class="divider-end mt-2"></span>
                  <div class="modal-body text-navy-blue">Jesse Robinson, our hardware architect, breathes life into the Boondock Echo. An experienced and innovative electronics engineer, Jesse is the force behind the robust and durable design of our device. He ensures the Boondock Echo withstands extreme conditions while maintaining its sleek, user-friendly design. Jesse's commitment to excellence and eye for detail make our product not only efficient but also aesthetically pleasing and easy to handle.
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="container content-space">
        ...
        <div class="row gx-3 mb-5 w-md-75 w-lg-100 mx-md-auto mb-5 mb-md-9" >
          ...
          <div class="col-sm-12 col-lg-4 mb-3 ">
            ...
            <div class="card card-transition " data-bs-toggle="modal"
              ...
              <div class="card-body">
                ...
                <!-- <p class=" lead text-navy-blue">Kaushlesh Chandel -<span
                  ...
                  <p class="card-text text-navy-blue">Suraj Tiwari, the mastermind behind cutting-edge backend architecture and automation, is driven by a deep fascination with optimize<a href="mySmallModalLabelkc"  data-bs-toggle="modal"
                  data-bs-target=".bd-example-modal-sm-suraj" class="text-muted">  ...read more</a></p>
              </div>
            ...
            <!-- End Card -->
            <!-- Modal -->
            <div class="modal modal-lg fade bd-example-modal-sm-suraj content-space-4"
              tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabelkc"
              aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h5 class="modal-title lead h4 text-navy-blue" id="mySmallModalLabelkc">Suraj Tiwari -</h5>
                    <h5 class="modal-title lead h4 text-primary" id="mySmallModalLabelkc">Infrastructure Architect</h5>
                    <button type="button" class="btn-close"
                      data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <span class="divider-end mt-2"></span>
                  <div class="modal-body text-navy-blue">Suraj Tiwari, the mastermind behind cutting-edge backend architecture and automation, is driven by a deep fascination with optimizing software systems. With a solid foundation in development and a passion for problem-solving, Suraj recognized the need for scalable solutions. His vision for efficient server management, streamlined databases, and automated processes has paved the way for groundbreaking applications. Suraj's commitment to pushing the boundaries of technology continues to inspire our team and shape the future of software development.
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-12 col-lg-4 mb-3 ">
            ...
            <div class="card card-transition" data-bs-toggle="modal"
              ...
              <div class="card-body">
              <div class="d-flex avatar avatar-xl  mb-4">
                  <img class="avatar-img" src="{{asset('front_asset/img/nandani_avtar1.png')}}  "
                    alt="Image Description">
                </div> 
                <!-- <p class=" lead text-navy-blue">Kaushlesh Chandel -<span
                  class="lead  text-primary  mb-1 "> The Firmware Maestro</span></p> -->
                  ...
                  <p class="card-text text-navy-blue"> Nandani Rathod, a skilled developer and UI/UX designer, is known for creating captivating responsive web applications. With a keen
                  <a href="mySmallModalLabelkc"  data-bs-toggle="modal"
                  data-bs-target=".bd-example-modal-sm-nandani" class="text-muted">  ...read more</a></p>
            ...
            <!-- End Card -->
            <!-- Modal -->
            <div class="modal modal-lg fade bd-example-modal-sm-nandani content-space-4"
              tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabelkc"
              aria-hidden="true">
              <div class="modal-dialog modal-lg " role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h5 class="modal-title lead h4 text-navy-blue" id="mySmallModalLabelkc">Nandani Rathod -</h5>
                    <h5 class="modal-title lead h4 text-primary" id="mySmallModalLabelkc">Application Architect</h5>
                  ...
                  <div class="modal-body text-navy-blue">
                    Nandani Rathod, a skilled developer and UI/UX designer, is known for creating captivating responsive web applications. With a keen eye for aesthetics and a focus on user-centric design, Nandani excels at crafting seamless and visually stunning experiences. Her ability to bridge the gap between design and functionality ensures each interaction leaves a lasting impression. Nandani's dedication to staying up to date with the latest trends and technologies drives her to continually deliver intuitive and engaging user experiences.</div>
                </div>
              </div>
            </div>
            <!-- End Modal -->
      ...
      <!-- Card -->
        <div class="card-body card card-transition text-center">
          <div class="d-flex align-items-center">
            ...
            <div class="flex-grow-1 ms-3">
              <h6 class="display-6 text-navy-blue">Our<span class="display-5 text-primary  lead mb-3"> Mission</span></h6>
          ...
          <!-- Blockquote -->
          <figure>
            <p class=" text-navy-blue">Our mission is to provide high-quality, cutting-edge technology which strive to offer solutions that improve the clarity, reliability, and convenience of using two-way radios, making it easier for you to communicate and stay connected, regardless of where you are .</p>
      ...
      <div class="card-body card card-transition text-center">
        <div class="d-flex align-items-center">
          <div class="flex-grow-1 ">
            <h6 class="display-6 text-navy-blue">Our<span class="display-5 text-primary  lead mb-3"> Vision</span></h6>
            <div class="border-top  border-10 my-3" style="max-width: 25rem;"></div>
            <!-- <span class="blockquote-footer-source">Happy customer</span> -->
          </div>
        ...
        <!-- Blockquote -->
        <figure>
          <p class=" text-navy-blue">Boondock Technologies is committed to pioneering advanced open-source wireless communication tools. Our vision is to leverage cutting-edge technology, transform global connectivity, and redefine the future of seamless, limitless communication.</p>
...
<!-- End Card Grid -->
    ...
    style="background-image: url('/assets/svg/components/wave-pattern-light.svg');" id="contact">
      <div
        class="container-xl  content-space-1 content-space-md-2 px-4 px-md-8 px-lg-3">
        ...
        <div class="row justify-content-lg-between align-items-lg-center" >
          <div class="col-md-10 col-lg-5 mb-9 mb-lg-0">
            ...
            <div class="border-top  border-white-10 my-3"
            style="max-width: 10rem;"></div>
            <div class="card bg-soft-light px-5 py-5">
              <h4 class="lead text-white">General Inquiries </h4>
              
              <p class= " text-muted">
                For general inquiries, product information, and press/media inquiries, please email us at</p>
            ...
            <div class="card bg-soft-light px-5 py-5">
              ...
              <p class= " text-muted">For technical assistance or product support, please contact our dedicated support team at</p>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <form id="contactForm">
                          ...
                          <div class="mb-3">
                            ...
                            <textarea class="form-control form-control-lg"
                              name="description" id="hireUsFormDetails"
                          ...
                          <div class="d-grid">
                            <button id="sendInquiryButton" type="submit"
                              class="btn btn-primary btn-lg">Send
                              inquiry</button>
                            <button id="loadingSpinnerButton" type="button"
                        ...
                        <div id="responseMessage"
                          class="alert alert-soft-success mt-5" role="alert"
                        ...
                        <script>
                          ...
                          form.addEventListener('submit', function(e) {
                            ...
                            fetch('https://dev.boondockdev.com/api/contacts', {
                                method: 'POST',
                                body: formData
                              })
                              .then(response => response.json())
          ...
          <div class=" content-space-2 gradient-y-gray px-lg-10 card-centered">
            <div class="row mb-1">
              <div class="col-lg-4 mb-3 mb-lg-0 col-md-6 col-sm-12 col-md-12">
                <!-- Logo -->
                <a href="{{asset('#home')}}" aria-label="Boondock-logo">
              ...
              <div class="col-6 col-md-6 col-lg-2 mb-5 mb-md-0 col-sm-6">
                ...
                <ul class="list-unstyled list-py-1 mb-0">
                  ...
                  <li><a class="text-black " href="{{asset('#about')}}">About</a></li>
                  <li><a class="text-black" href="{{asset('#services')}}">Services</a></li>
                  <li><a class="text-black" href="{{asset('#team')}}">Team</a></li>
                  <!-- <li><a class="text-black" href="{{asset('#pricing')}}">Pricing</a></li> -->
                  <li><a class="text-black" href="{{asset('#contact')}}">Contact</a></li>
              ...
              <div class="modal-body">
                ...
                <div id="loginModalFormLogin">
                  ...
                  <div class="text-center mb-7">
                    <h3 class="modal-title">Log in to Boondock</h3>
                  ...
                  <form class="js-validate needs-validation" novalidate>
                    <!-- Form -->
                    <div class="mb-3">
                      <label class="form-label" for="loginModalFormLoginEmail">Your
                        email</label>
                      <input type="email" class="form-control" name="email"
                        id="loginModalFormLoginEmail"
                    ...
                    <div class="mb-3">
                      <div
                        ...
                        <label class="form-label"
                          for="loginModalFormLoginPassword">Password</label>

                        <a class="js-animation-link form-label-link"
                     ...
                     "groupName": "idForm"
                      ...
                      <input type="password"
                        ...
                        id="loginModalFormLoginPassword"
                        placeholder="8+ characters required"
                        aria-label="8+ characters required" required
                        minlength="8">
                      <span class="invalid-feedback">Please enter a valid
                        password.</span>
                    </div>
                    <!-- End Form -->
                    ...
                    <div class="d-grid gap-3 text-center">
                      ...
                      <p>Don't have an account yet?
                        <a class="js-animation-link link" href="javascript:;"
                          role="button" data-hs-show-animation-options='{
                ...
                <div id="loginModalFormSignup"
                  ...
                  <form class="js-validate needs-validation" novalidate>
                    <!-- Form -->
                    <div class="mb-3">
                      <label class="form-label" for="loginModalFormSignupEmail">Your
                        email</label>
                      <input type="email" class="form-control form-control-lg"
                        name="email" id="loginModalFormSignupEmail"
                        placeholder="email@site.com" aria-label="email@site.com"
                        required>
                      <span class="invalid-feedback">Please enter a valid email
                        address.</span>
                    ...
                    <div class="mb-3">
                      <label class="form-label"
                        for="loginModalFormSignupPassword">Password</label>
                      <input type="password"
                        class="form-control form-control-lg" name="password"
                        id="loginModalFormSignupPassword"
                        placeholder="8+ characters required"
                        aria-label="8+ characters required" required>
                      <span class="invalid-feedback">Your password is invalid.
                    ...
                    <div class="mb-3" data-hs-validation-validate-class>
                      <label class="form-label"
                        for="loginModalFormSignupConfirmPassword">Confirm
                        password</label>
                      <input type="password"
                        class="form-control form-control-lg"
                        name="confirmPassword"
                        id="loginModalFormSignupConfirmPassword"
                        placeholder="8+ characters required"
                        aria-label="8+ characters required" required
                        data-hs-validation-equal-field="#loginModalFormSignupPassword">
                      <span class="invalid-feedback">Password does not match the
                ...
                <!-- Reset Password -->
                <div id="loginModalFormResetPassword"
                  style="display: none; opacity: 0;">
                  <!-- Heading -->
                  <div class="text-center mb-7">
                  ...
                  <form class="js-validate needs-validation" novalidate>
                    ...
                    <div class="mb-3">
                      <div
                        class="d-flex justify-content-between align-items-center">
                        <label class="form-label"
                          for="loginSignupModalFormResetPasswordEmail"
                      ...
                      <input type="email" class="form-control form-control-lg"
                        name="email"
                        id="loginSignupModalFormResetPasswordEmail" tabindex="1"
              ...
              <div class="modal-body">
                  ...
                  <div class="d-grid gap-2">
                    <a class="btn btn-white btn-lg" href="#">
                      <span
                        class="d-flex justify-content-center align-items-center">
                        <img class="avatar avatar-xss me-2"
                          src="{{asset('front_asset/svg/brands/google-icon.svg')}}"
                          alt="Image Description">
                        Log in with Google
                      </span>
                    </a>
                ...
                <div id="signupModalFormLoginWithEmail"
                  ...
                  <form class="js-validate needs-validation" novalidate>
                    <!-- Form -->
                    <div class="mb-3">
                      <label class="form-label" for="signupModalFormLoginEmail">Your
                        email</label>
                      <input type="email" class="form-control form-control-lg"
                        name="email" id="signupModalFormLoginEmail"
                        placeholder="email@site.com" aria-label="email@site.com"
                        required>
                      <span class="invalid-feedback">Please enter a valid email
                        address.</span>
                    ...
                    <div class="mb-3">
                      <div
                        class="d-flex justify-content-between align-items-center">
                        <label class="form-label"
                          for="signupModalFormLoginPassword">Password</label>
                    ...
                    <div class="d-grid mb-3">
                      <button type="submit"
                        class="btn btn-primary form-control-lg">Log in</button>
                    </div>
                  </form>
                </div>
                ...
                <div id="signupModalFormSignupWithEmail"
                  ...
                  <form class="js-validate need-validate" novalidate>
                    <!-- Form -->
                    <div class="mb-3">
                      <label class="form-label" for="signupModalFormSignupEmail">Your
                        email</label>
                      <input type="email" class="form-control form-control-lg"
                        name="email" id="signupModalFormSignupEmail"
                        placeholder="email@site.com" aria-label="email@site.com"
                        required>
                      <span class="invalid-feedback">Please enter a valid email
                        address.</span>
                    ...
                    <div class="mb-3">
                      <label class="form-label"
                        for="signupModalFormSignupPassword">Password</label>
                      <input type="password"
                        class="form-control form-control-lg" name="password"
                    ...
                    <div class="mb-3" data-hs-validation-validate-class>
                      <label class="form-label"
                        for="signupModalFormSignupConfirmPassword">Confirm
                        password</label>
                      <input type="password"
                        class="form-control form-control-lg"
                        name="confirmPassword"
                    ...
                    <div class="d-grid mb-3">
                      <button type="submit"
                        class="btn btn-primary form-control-lg">Sign up</button>
                    </div>
                ...
                <!-- Reset Password -->
                <div id="signupModalFormResetPassword"
                  style="display: none; opacity: 0;">
                  <!-- Heading -->
                  <div class="text-center mb-7">
                  ...
                  <form class="js-validate need-validate" novalidate>
                    <div class="mb-3">
                      ...
                      <div
                        class="d-flex justify-content-between align-items-center">
                        <label class="form-label"
                          for="signupModalFormResetPasswordEmail" tabindex="0">Your
                          email</label>
                    ...
                    <div class="d-grid">
                      <button type="submit"
                        class="btn btn-primary form-control-lg">Submit</button>
                    </div>
                  </form>
                </div>
                <!-- End Reset Password -->
              ...
              <div class="modal-footer d-block text-center py-sm-5">
                ...
                <div class="w-85 mx-auto">
                  <div class="row justify-content-between">
                    <div class="col">
                      <img class="img-fluid"
                        src="{{asset('front_asset/svg/brands/gitlab-gray.svg')}}" alt="Logo">
                    </div>
                    <!-- End Col -->

                    <div class="col">
                      <img class="img-fluid"
                        src="{{asset('front_asset/svg/brands/fitbit-gray.svg')}}" alt="Logo">
                    </div>
                    <!-- End Col -->

                    <div class="col">
                      <img class="img-fluid"
                        src="{{asset('front_asset/svg/brands/flow-xo-gray.svg')}}" alt="Logo">
                    </div>
                    <!-- End Col -->

                    <div class="col">
                      <img class="img-fluid"
                        src="{{asset('front_asset/svg/brands/layar-gray.svg')}}" alt="Logo">
                    </div>
                    <!-- End Col -->
                  </div>
                </div>
