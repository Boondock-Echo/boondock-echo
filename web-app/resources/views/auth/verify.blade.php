    ...
    <main id="content" role="main" class="main">
        ...
        <div class="container py-5 py-sm-7">
            <a class="d-flex justify-content-center mb-5" href="./index.html">
                <img class="zi-2" src="{{asset('assets/img/front/logo-name.png')}}" alt="Image Description" style="width: 8rem;">
            </a>
            ...
            <div class="mx-auto" style="max-width: 30rem;">
                ...
                <div class="card card-lg mb-5">
                    <div class="card-body text-center">
                        <div class="mb-4">
                            <img class="avatar avatar-xxl avatar-4x3"
                                src="{{asset('assets/svg/illustrations/oc-email-verification.svg')}}" alt="Image Description"
                                data-hs-theme-appearance="default">
                            <img class="avatar avatar-xxl avatar-4x3"
                                src="{{asset('assets/svg/illustrations-light/oc-email-verification.svg')}}" alt="Image Description"
                        ...
                        <span class="d-block text-dark fw-semibold  mb-5"> {{auth()->user()->email}} </span>
                    ...
                    @endif
                        <p>Didn't receive an email? <a href="#"></a></p>
                        <div class="mt-4 mb-3">
                ...
                <div class="position-relative text-center zi-1">
                    <small class="text-cap text-body mb-4">Trusted by the world's best team</small>
