...
<body class="d-flex align-items-center min-h-100">
  ...
  <header class="position-absolute top-0 start-0 end-0 mt-3 mx-3">
    <div class="d-flex d-lg-none justify-content-between">
      <a href="./index.html">
        <img class="w-100" src="./assets/img/front/logo-name.png" alt="Image Description" data-hs-theme-appearance="default" style="min-width: 7rem; max-width: 7rem;">
        ...
        <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center min-vh-lg-100 position-relative bg-light px-0">
          ...
          <div style="max-width: 23rem;">
            <div class="text-center mb-5">
              <img class="img-fluid" src="./assets/img/front/boondock-logo.png" alt="Image Description" style="width: 24rem;" data-hs-theme-appearance="default">
            ...
            <form method="POST" action="{{ route('register') }}" class="js-validate needs-validation" novalidate>
              ...
              <div class="text-center">
                <div class="mb-5">
                  ...
                  <p>Already have an account? <a class="link" href="./login.html">Sign in here</a></p>
                </div>
              ...
              <div class="row">
                <div class="col-sm-6">
                  <!-- Form -->
                  <div class="mb-4">
                    <input id="name" type="text" class="form-control form-control-lg" name="name"  placeholder="Mark" value="{{ old('name') }}" aria-label="Mark" required>
              ...
              <div class="mb-4">
                ...
                <input id="email" type="email" class="form-control form-control-lg" name="email"  placeholder="Markwilliams@site.com" value="{{ old('email') }}" aria-label="Markwilliams@site.com" required>
              ...
              <div class="mb-4">
                ...
                <div class="input-group input-group-merge" data-hs-validation-validate-class>
                  <input id="password" type="password" class="js-toggle-password form-control form-control-lg" name="password" id="signupSrPassword" placeholder="8+ characters required" aria-label="8+ characters required" required minlength="8" data-hs-toggle-password-options='{
              ...
              <div class="mb-4">
                ...
                <div class="input-group input-group-merge" data-hs-validation-validate-class>
                  <input id="password-confirm" type="password" class="js-toggle-password form-control form-control-lg" name="confirmPassword"  placeholder="8+ characters required" aria-label="8+ characters required" required minlength="8" data-hs-toggle-password-options='{
                           "target": [".js-toggle-password-target-1", ".js-toggle-password-target-2"],
                           "defaultClass": "bi-eye-slash",
                           "showClass": "bi-eye",
