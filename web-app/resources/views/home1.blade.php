  ...
  <header id="header" class="navbar navbar-expand-lg navbar-fixed navbar-height navbar-container navbar-bordered bg-white">
    <div class="navbar-nav-wrap">
      ...
      <a class="navbar-brand" href="./home" aria-label="Front">
        <img class="navbar-brand-logo" src="./assets/img/front/logo-name.png" alt="Logo" data-hs-theme-appearance="default">
        <img class="navbar-brand-logo" src="./assets/img/front/logo-name.png" alt="Logo" data-hs-theme-appearance="dark">
    ...
    <div class="navbar-vertical-container">
      <div class="navbar-vertical-footer-offset">
        ...
        <a class="navbar-brand" href="./" aria-label="Front">
          <img class="navbar-brand-logo" style="min-width: 10.5rem;" src="./assets/img/front/logo-name.png" alt="Logo" data-hs-theme-appearance="default">
          <img class="navbar-brand-logo" style="min-width: 10.5rem;" src="./assets/img/front/logo-name.png" alt="Logo" data-hs-theme-appearance="dark">
          <img class="navbar-brand-logo-mini" src="./assets/svg/logos/logo-short.svg" alt="Logo" data-hs-theme-appearance="default">
          <img class="navbar-brand-logo-mini" src="./assets/svg/logos-light/logo-short.svg" alt="Logo" data-hs-theme-appearance="dark">
        </a>
        ...
        <div class="navbar-vertical-content">
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            ...
            <span class="dropdown-header mt-4">Messages</span>
            ...
            <div id="navbarVerticalMenuPagesMenu">
              <div class="nav-item">
                <a class="nav-link active" href="#" data-placement="left">
                  ...
                  <span class="nav-link-title">Inbox</span>
                </a>
              </div>

              <div class="nav-item">
                <a class="nav-link " href="#" data-placement="left">
                  <i class="bi-send nav-icon"></i>
                  <span class="nav-link-title">Outbox</span>
                </a>
              </div>
              <div class="nav-item">
                <a class="nav-link " href="#" data-placement="left">
              ...
              <div class="nav-item">
                <a class="nav-link " href="#" data-placement="left">
                  <i class="bi-broadcast-pin nav-icon"></i>
                  <span class="nav-link-title">My Dock</span>
                </a>
              </div>
              ...
              <small class="bi-three-dots nav-subtitle-replacer"></small>
                  <a class="nav-link " href="#">Assign Docks</a>
                  <a class="nav-link " href="#">Manage Accounts</a>
                  <a class="nav-link " href="#">Manage Users <span class="badge bg-info rounded-pill ms-1">Hot</span></a>
                </div>
              </div>
              <!-- End Collapse -->
              <div class="nav-item">
